...
export const releaseChecklistStages: ReleaseChecklistStage[] = [
  ...
  },
  {
    ...
    status: 'critical',
    goal: 'Fazer o app parecer e ensinar como uma ferramenta CLP: tags, comentários, Force didático, rotinas, diagnóstico e saída clara por rung.',
    readyDefinition: 'O usuário consegue consultar tabela de tags, editar comentários, aplicar Force ON/OFF didático, ver rotinas e alertas de segurança.',
    checklist: [
      ...
      { id: 'routines', text: 'Conferir rotinas MainRoutine, MotorControl, SafetyLogic e Sequencer.' },
      { id: 'diagnostics', text: 'Conferir diagnóstico de scan, linhas ativas, entradas, saídas, timers e contadores.' },
    ],
    evidence: ['ProfessionalClpPanel', 'ProfessionalRoutinePanel', 'professionalClpView', 'professionalRoutineModel', 'Smartphone program regressions'],
  },
  {
    id: 'guided_learning',
    title: 'Ensino guiado',
  ...
  },
  {
    ...
    status: 'important',
    goal: 'Dar valor educacional com dialetos CLP, protocolos, tags profissionais, rotinas e segurança sem dizer que é compatibilidade oficial.',
    readyDefinition: 'A aba Referência explica Rockwell-like, IEC-like, Comandos, tags, rotinas, Modbus, MQTT, ESPHome e cuidados de segurança com linguagem clara.',
    checklist: [
      ...
      { id: 'routines', text: 'Conferir guia de rotinas/programas.' },
    ...
    evidence: ['PlcProfilePanel', 'ReferenceHubPanel', 'ProfessionalRoutinePanel', 'CommunicationProtocolsPanel', 'SafetyReadinessPanel'],
  },
  {
    id: 'monetization',
