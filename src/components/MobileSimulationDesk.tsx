...
const styles = StyleSheet.create({
  ...
  runPill: { borderColor: colors.borderStrong, borderWidth: 1, borderRadius: 14, paddingHorizontal: spacing.sm, paddingVertical: 5, backgroundColor: colors.surfaceElevated, alignItems: 'center' },
  runPillAuto: { borderColor: colors.green, backgroundColor: colors.greenSoft },
  runText: { color: colors.textMuted, fontSize: 10, fontWeight: '900' },
  runTextAuto: { color: colors.green },
  scanText: { color: colors.textMuted, fontSize: 9, fontWeight: '800', marginTop: 1 },
  ioPanel: { borderColor: colors.border, borderWidth: 1, borderRadius: 16, padding: spacing.sm, backgroundColor: colors.surfaceElevated, gap: spacing.xs },
  panelTitle: { color: colors.text, fontSize: 11, fontWeight: '900', textTransform: 'uppercase' },
  signalStrip: { gap: spacing.xs, paddingRight: spacing.xs },
  inputButton: { width: 104, borderColor: colors.border, borderWidth: 1, borderRadius: 14, padding: spacing.sm, backgroundColor: colors.surface, alignItems: 'center' },
  inputButtonOn: { borderColor: colors.green, backgroundColor: colors.greenSoft },
  signalAddress: { color: colors.text, fontFamily: 'monospace', fontSize: 12, fontWeight: '900' },
  signalAddressOn: { color: colors.green },
  signalName: { color: colors.textMuted, fontSize: 10, fontWeight: '800', marginTop: 2, maxWidth: 88 },
  signalState: { color: colors.textMuted, fontSize: 11, fontWeight: '900', marginTop: 4 },
  signalStateOn: { color: colors.green },
  rungHeader: { flexDirection: 'row', alignItems: 'center', gap: spacing.xs },
  rungNavButton: { width: 38, height: 38, borderRadius: 999, borderColor: colors.border, borderWidth: 1, alignItems: 'center', justifyContent: 'center', backgroundColor: colors.surfaceElevated },
  rungNavText: { color: colors.text, fontSize: 24, fontWeight: '900' },
  ...
  rungSubtitle: { color: colors.textMuted, fontSize: 10, fontWeight: '800', marginTop: 1 },
